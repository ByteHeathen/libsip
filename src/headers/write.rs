...
impl fmt::Display for Header {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            Header::To(name, uri) => write_named_header("To", name, uri, f),
            Header::From(name, uri) => write_named_header("From", name, uri, f),
            Header::Contact(name, uri) => write_named_header("Contact", name, uri, f),
            Header::ReplyTo(name, uri) => write_named_header("Reply-To", name, uri, f),
            ...
            Header::Accept(methods) => write_array_header("Accept", f, methods),
            Header::Allow(methods) => write_array_header("Allow", f, methods),
            ...
            Header::Supported(data) => write!(f, "Supported: {}", data),
...
fn write_named_header(header: &str, name: &Option<String>, uri: &Uri, f: &mut fmt::Formatter) -> fmt::Result {
    write!(f, "{}: ", header)?;
...
fn write_array_header(name: &str, f: &mut fmt::Formatter, v: &Vec<Method>) -> fmt::Result {
    write!(f, "{}: ", name)?;
